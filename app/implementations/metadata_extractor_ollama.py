...
class OllamaMetadataExtractor:
    ...
    def extract(self, chunk: Chunk, schema: MetadataSchema) -> dict:
        ...
        prompt = (
            ...
            "WICHTIG: Falsch extrahierte Filterwerte schließen später relevante Textstellen aus.\n"
            "Beim Feld verzahnungstyp darfst du nur einen Typ setzen, wenn er eindeutig im Chunk belegt ist.\n"
            "Wenn du unsicher bist oder mehrere Typen möglich sind, lasse verzahnungstyp leer/null.\n\n"
