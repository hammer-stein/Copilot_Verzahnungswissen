...
class BGEM3Embedder:
    ...
    def __init__(self, *, model_name: str, device: str, max_length: int, use_sparse: bool) -> None:
        """
        Lädt das Modell in den Speicher – teuerste Operation beim Start (~5–15 Sekunden).
        use_sparse ist als Erweiterungspunkt für zukünftigen Hybrid-Search reserviert.
        """
